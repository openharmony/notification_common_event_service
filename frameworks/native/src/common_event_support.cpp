...
void CommonEventSupport::Init()
{
    ...
    */
     ...
     * Only for test case.
     */
    commonEventSupport_.emplace_back(CommonEventSupport::COMMON_EVENT_TEST_ACTION1);

    /**
     * Only for test case.
     */
    commonEventSupport_.emplace_back(CommonEventSupport::COMMON_EVENT_TEST_ACTION2);
    ...
    */
     ...
     * This is a protected common event that can only be sent by system.
     */
    commonEventSupport_.emplace_back(CommonEventSupport::COMMON_EVENT_PRIVACY_STATE_CHANGED);
