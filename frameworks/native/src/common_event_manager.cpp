...
int32_t CommonEventManager::SetStaticSubscribeEventState(bool enable)
{
    return DelayedSingleton<CommonEvent>::GetInstance()->SetStaticSubscribeEventState(enable);
}
}  // namespace EventFwk
}  // namespace OHOS