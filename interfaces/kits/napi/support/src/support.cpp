...
napi_value SupportInit(napi_env env, napi_value exports)
{
    ...
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_EXTERNAL_APPLICATIONS_UNAVAILABLE,
    ...
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_WIFI_P2P_PEERS_STATE_CHANGED,
        "COMMON_EVENT_WIFI_P2P_PEERS_STATE_CHANGED");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_WIFI_P2P_PEERS_DISCOVERY_STATE_CHANGED,
        "COMMON_EVENT_WIFI_P2P_PEERS_DISCOVERY_STATE_CHANGED");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_WIFI_P2P_CURRENT_DEVICE_STATE_CHANGED,
        "COMMON_EVENT_WIFI_P2P_CURRENT_DEVICE_STATE_CHANGED");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_WIFI_P2P_GROUP_STATE_CHANGED,
        "COMMON_EVENT_WIFI_P2P_GROUP_STATE_CHANGED");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_HANDSFREE_AG_CONNECT_STATE_UPDATE,
    ...
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_HANDSFREE_AG_AUDIO_STATE_UPDATE,
    ...
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_A2DPSOURCE_PLAYING_STATE_UPDATE,
        "COMMON_EVENT_BLUETOOTH_A2DPSOURCE_PLAYING_STATE_UPDATE");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_A2DPSOURCE_AVRCP_CONNECT_STATE_UPDATE,
    ...
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_CLASS_VALUE_UPDATE,
        "COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_CLASS_VALUE_UPDATE");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_ACL_CONNECTED,
        "COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_ACL_CONNECTED");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_ACL_DISCONNECTED,
    ...
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_SDP_RESULT,
        "COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_SDP_RESULT");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_UUID_VALUE,
        "COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_UUID_VALUE");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_PAIRING_REQ,
        "COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_PAIRING_REQ");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_PAIRING_CANCEL,
        "COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_PAIRING_CANCEL");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_CONNECT_REQ,
        "COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_CONNECT_REQ");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_CONNECT_REPLY,
        "COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_CONNECT_REPLY");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_CONNECT_CANCEL,
        "COMMON_EVENT_BLUETOOTH_REMOTEDEVICE_CONNECT_CANCEL");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_HANDSFREEUNIT_CONNECT_STATE_UPDATE,
        "COMMON_EVENT_BLUETOOTH_HANDSFREEUNIT_CONNECT_STATE_UPDATE");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_HANDSFREEUNIT_AUDIO_STATE_UPDATE,
        "COMMON_EVENT_BLUETOOTH_HANDSFREEUNIT_AUDIO_STATE_UPDATE");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_HANDSFREEUNIT_AG_COMMON_EVENT,
        "COMMON_EVENT_BLUETOOTH_HANDSFREEUNIT_AG_COMMON_EVENT");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_HANDSFREEUNIT_AG_CALL_STATE_UPDATE,
        "COMMON_EVENT_BLUETOOTH_HANDSFREEUNIT_AG_CALL_STATE_UPDATE");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_HOST_STATE_UPDATE,
        "COMMON_EVENT_BLUETOOTH_HOST_STATE_UPDATE");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_HOST_REQ_DISCOVERABLE,
        "COMMON_EVENT_BLUETOOTH_HOST_REQ_DISCOVERABLE");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_HOST_REQ_ENABLE,
        "COMMON_EVENT_BLUETOOTH_HOST_REQ_ENABLE");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_HOST_REQ_DISABLE,
        "COMMON_EVENT_BLUETOOTH_HOST_REQ_DISABLE");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_HOST_SCAN_MODE_UPDATE,
    ...
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_HOST_DISCOVERY_FINISHED,
        "COMMON_EVENT_BLUETOOTH_HOST_DISCOVERY_FINISHED");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_HOST_NAME_UPDATE,
        "COMMON_EVENT_BLUETOOTH_HOST_NAME_UPDATE");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_A2DPSINK_CONNECT_STATE_UPDATE,
        "COMMON_EVENT_BLUETOOTH_A2DPSINK_CONNECT_STATE_UPDATE");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_A2DPSINK_PLAYING_STATE_UPDATE,
        "COMMON_EVENT_BLUETOOTH_A2DPSINK_PLAYING_STATE_UPDATE");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_BLUETOOTH_A2DPSINK_AUDIO_STATE_UPDATE,
    ...
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_NFC_ACTION_RF_FIELD_ON_DETECTED,
    ...
    SetNamedPropertyByStr(
        env, obj, EventFwk::CommonEventSupport::COMMON_EVENT_DISK_VOLUME_STATE_CHANGE,
    ...
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_INCOMING_CALL_MISSED,
    ...
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_SIM_CARD_DEFAULT_SMS_SUBSCRIPTION_CHANGED,
        "COMMON_EVENT_SIM_CARD_DEFAULT_SMS_SUBSCRIPTION_CHANGED");
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_SIM_CARD_DEFAULT_MAIN_SUBSCRIPTION_CHANGED,
    ...
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_SIGNAL_INFO_CHANGED,
    ...
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_USER_INFO_UPDATED,
    ...
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_DEFAULT_APPLICATION_CHANGED,
    ...
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_SCREEN_SHARE,
    ...
    SetNamedPropertyByStr(env,
        obj,
        EventFwk::CommonEventSupport::COMMON_EVENT_TABLET_MODE_CHANGED,
