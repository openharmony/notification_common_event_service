...
public:
    ...
    static napi_value SetStaticSubscriberState(napi_env env, napi_callback_info info);
...
public:
    ...
    static constexpr napi_type_tag typeTag = {0x90b0b31bbb8914a2, 0xbe4b1011840a48a9};
