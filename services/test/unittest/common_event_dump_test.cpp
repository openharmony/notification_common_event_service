...
const std::string EVENTCASE1 = "com.ces.dump_test.event.case1";
const std::string EVENTCASE2 = "com.ces.dump_test.event.case2";
const std::string EVENTCASE3 = "com.ces.dump_test.event.case3";
