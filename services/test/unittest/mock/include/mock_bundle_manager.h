...
public:
    ...
    /**
     * @brief Checks whether the app is system app by it's UID.
     * @param uid Indicates the uid.
    ...
    /**
     * @brief Queries the AbilityInfo by the given Want.
    ...
    /**
     * @brief Queries the AbilityInfo of list by the given Want.
     * @param want Indicates the information of the ability.
    ...
    /**
     * @brief Obtains the HAP module info of a specific ability.
    ...
    /**
     * @brief Registers the specific bundle status callback.
    ...
    /**
     * @brief Clears the specific bundle status callback.
    ...
    /**
     * @brief Unregisters all the callbacks of status changed.
     * @return Returns true if this function is successfully called; returns false otherwise.
     */
    ...
    /**
     * @brief Dumps the bundle informations with specific flags.
