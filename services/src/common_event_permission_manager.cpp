...
static const std::unordered_map<std::string, std::vector<int32_t>> COMMON_EVENT_MAP_PUBLISHER {
    ...
    {CommonEventSupport::COMMON_EVENT_USER_BACKGROUND, {ACCOUNT_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_USER_FOREGROUND, {ACCOUNT_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_USER_STOPPING, {ACCOUNT_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_USER_STOPPED, {ACCOUNT_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_HWID_TOKEN_INVALID, {ACCOUNT_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_DISTRIBUTED_ACCOUNT_TOKEN_INVALID, {ACCOUNT_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_HWID_LOGOFF, {ACCOUNT_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_DISTRIBUTED_ACCOUNT_LOGOFF, {ACCOUNT_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_USER_INFO_UPDATED, {ACCOUNT_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_DOMAIN_ACCOUNT_STATUS_CHANGED, {ACCOUNT_UID, BROKER_UID}},
    ...
    {CommonEventSupport::COMMON_EVENT_HTTP_PROXY_CHANGE, {CONNECT_UID, BROKER_UID}},
    ...
    {CommonEventSupport::COMMON_EVENT_SANDBOX_PACKAGE_ADDED, {BMS_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_SANDBOX_PACKAGE_REMOVED, {BMS_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_PACKAGE_CHANGED, {BMS_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_PACKAGE_INSTALLATION_STARTED, {BMS_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_OVERLAY_PACKAGE_ADDED, {BMS_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_OVERLAY_PACKAGE_CHANGED, {BMS_UID, BROKER_UID}},
    ...
    {CommonEventSupport::COMMON_EVENT_CALL_STATE_CHANGED, {BMS_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_SMS_RECEIVE_COMPLETED, {PHONE_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_SMS_EMERGENCY_CB_RECEIVE_COMPLETED, {PHONE_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_SMS_WAPPUSH_RECEIVE_COMPLETED, {PHONE_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_NITZ_TIME_CHANGED, {PHONE_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_NITZ_TIMEZONE_CHANGED, {PHONE_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_SIM_STATE_CHANGED, {PHONE_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_SIM_CARD_DEFAULT_MAIN_SUBSCRIPTION_CHANGED, {PHONE_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_SET_PRIMARY_SLOT_STATUS, {PHONE_UID, BROKER_UID}},
    {CommonEventSupport::COMMON_EVENT_CELLULAR_DATA_STATE_CHANGED, {PHONE_UID, BROKER_UID}},
};
